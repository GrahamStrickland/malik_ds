...
int main() {
    ...
    std::cout << "listThousand.insertionSort(): comparisons = "
              << comparisons << ", assignments = " << assignments
              << '\n';
    comparisons = 0;
    assignments = 0;
    listThousand.shellSort(comparisons, assignments);
    std::cout << "listThousand.shellSort(): comparisons = "
              << comparisons << ", assignments = " << assignments
              << '\n';
    comparisons = 0;
    assignments = 0;
    ...
    std::cout << "listTenThousand.insertionSort(): comparisons = "
              << comparisons << ", assignments = " << assignments
              << '\n';
    comparisons = 0;
    assignments = 0;
    listTenThousand.insertionSort(comparisons, assignments);
    std::cout << "listTenThousand.shellSort(): comparisons = "
              << comparisons << ", assignments = " << assignments
              << '\n';
