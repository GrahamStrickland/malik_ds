...
public:
    ...
    const candidateType& operator=(const personType&);
        ...
        //the value of an oboject of type personType can be
    ...
    void printData() const;
        ...
        //received in each regiion, and the total votes received.

    candidateType();
        //Default constructor.
        //Postcondition: Candidate's name is initialized to blanks,
        //  the number of votes in each regiion, and the total
