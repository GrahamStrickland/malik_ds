...
public:
    ...
    void shellSort(int& comparisons, int& assignments);
        //Function to sort elements in the list, increasing the
...
protected:
    ...
    void intervalInsertionSort(int begin, int inc, int& comparisons,
        int& assignments);
...
template <class elemType>
bool arrayListType<elemType>::isItemEqualAt
...
template <class elemType>
void arrayListType<elemType>::insertionSort(int& comparisons,
    int& assignments)
{
...
template <class elemType>
void arrayListType<elemType>::shellSort(int& comparisons, 
    int& assignments)
{
    int inc;
    ...
    do
    {
        for (int begin = 0; begin < inc; begin++) {
            comparisons++;
            assignments++;
            intervalInsertionSort(begin, inc, comparisons, assignments);
        }
        inc = inc / 3;
        comparisons++;
        assignments += 2;
