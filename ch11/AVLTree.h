...
template <class elemType>
void AVLTree<elemType>::inorderTraversal
...
template <class elemType>
void AVLTree<elemType>::preorderTraversal
                                (void (*visit) (elemType& item))
{
...
template <class elemType>
void AVLTree<elemType>::postorderTraversal
                                (void (*visit) (elemType& item))
{
...
template <class elemType>
int AVLTree<elemType>::treeNodeCount() const
{
    return nodeCount(this->root);
}

template <class elemType>
int AVLTree<elemType>::treeLeavesCount() const
{
...
template <class elemType>
void AVLTree<elemType>::
                    inorder(AVLNode<elemType> *p) const
{
    if (p != NULL)
    {
        inorder(p->llink);
...
template <class elemType>
void AVLTree<elemType>::
                    preorder(AVLNode<elemType> *p) const
{
    if (p != NULL)
    {
        std::cout << p->info << " ";
...
template <class elemType>
void AVLTree<elemType>::
                    postorder(AVLNode<elemType> *p) const
{
    if (p != NULL)
    {
        postorder(p->llink);
