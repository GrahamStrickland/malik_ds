...
template <class Type> class linkedQueueType : public queueADT<Type> {
public:
...
template <class Type> bool linkedQueueType<Type>::isEmptyQueue() const {
  return (queueFront == NULL);
} // end isEmptyQueue

template <class Type> bool linkedQueueType<Type>::isFullQueue() const {
  return false;
} // end isFullQueue

template <class Type> void linkedQueueType<Type>::initializeQueue() {
  nodeType<Type> *temp;
...
template <class Type> Type linkedQueueType<Type>::front() const {
  assert(queueFront != NULL);
  return queueFront->info;
} // end front

template <class Type> Type linkedQueueType<Type>::back() const {
  assert(queueRear != NULL);
  return queueRear->info;
} // end back

template <class Type> int linkedQueueType<Type>::queueCount() const {
  return count;
} // end queueCount
...
template <class Type> void linkedQueueType<Type>::deleteQueue() {
  nodeType<Type> *temp;
...
template <class Type> linkedQueueType<Type>::linkedQueueType() {
