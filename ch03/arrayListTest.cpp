...
int main() {
  ...
  intList.print();
  cout << "Minimum: " << intList.min() << ", maximum: " << intList.max() << endl
       << endl;

  cout << "Line 21: Enter the item to be deleted: ";
  cin >> number;
  intList.remove(number);
  cout << "Line 24: After removing " << number << ", the list is:" << endl;
  intList.print();
  cout << endl;
  ...
  stringList.print();
  cout << "Minimum: " << stringList.min() << ", maximum: " << stringList.max()
       << endl
       << endl;
  ...
  cout << "Line 41: After removing " << str << ", the list is:" << endl;
  stringList.print();
  cout << endl;
  ...
  doubleList.print();
  cout << "Minimum: " << doubleList.min() << ", maximum: " << doubleList.max()
       << endl
       << endl;
  ...
  cout << "Line 56: After removing " << dec << ", the list is:" << endl;
  doubleList.print();
  cout << endl;
