...
int main() {
  ...
  for (int i = list.getFirstIndex(); i <= list.getLastIndex(); i++)
    list[i] = i;
  for (int i = yourList.getFirstIndex(); i <= yourList.getLastIndex(); i++)
  ...
  for (int i = list2.getFirstIndex(); i <= list2.getLastIndex(); i++)
