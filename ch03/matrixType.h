...
class matrixType {
public:
  friend ostream &operator<<(ostream &outs, const matrixType &outpMat);
  ...
  const matrixType &operator=(const matrixType &rightMatrix);
  // Overloaded assignment operator.

  matrixType operator+(const matrixType &rightMatrix);
