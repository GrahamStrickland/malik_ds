...
void evaluateExpression(ifstream &inpF, ofstream &outF,
                        stack<double> &exprStack, char &ch, bool &isExpOk);
void evaluateOpr(ofstream &out, stack<double> &exprStack, char &ch,
                 bool &isExpOk);
void discardExp(ifstream &in, ofstream &out, char &ch);
void printResult(ofstream &outF, stack<double> &exprStack, bool isExpOk);
...
int main() {
  ...
  while (infile) {
    expressionOk = true;
    outfile << ch;
    evaluateExpression(infile, outfile, exprStack, ch, expressionOk);
