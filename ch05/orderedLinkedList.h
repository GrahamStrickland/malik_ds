                  ...
                  orderedLinkedList<Type> &list2)
{
    ...
    if (list1.last != NULL) insert(list1.last.getInfo());
    list1.destroyList();
    ...
    if (list2.last != NULL) insert(list2.last.getInfo());
    list2.destroyList();
}//end mergeLists
...
void orderedLinkedList<Type>::deleteNode(const Type& deleteItem)
{
    ...
    else
    {
        ...
        if (current == NULL)    //Case 4
            ...
            if (current.getInfo() == deleteItem)    //the item to be
...
template <class Type>
void orderedLinkedList<Type>::deleteItemAt(int k)
